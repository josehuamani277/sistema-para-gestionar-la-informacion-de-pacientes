...
INSERT INTO [dbo].[Tratamientos] ([Paciente_ID], [Medico_ID], [descripcion], [duracion])
VALUES
(1, 1, 'Control de diabetes tipo 2 con medicación y dieta', 15),
(2, 2, 'Revisión neurológica con evaluación de síntomas', 12),
(3, 3, 'Consulta pediátrica para evaluación de crecimiento', 18),
(4, 4, 'Examen ginecológico de rutina', 14),
(5, 5, 'Tratamiento para eczema con cremas tópicas', 17),
(6, 6, 'Evaluación y tratamiento para problemas de visión', 20),
(7, 7, 'Evaluación psiquiátrica para ansiedad', 13),
(8, 8, 'Tratamiento ortopédico para dolor de espalda', 16),
(9, 9, 'Tratamiento endocrinológico para tiroides', 11),
(10, 10, 'Evaluación oncológica para masa mamaria', 19),
(11, 11, 'Tratamiento reumatológico para artritis', 14),
(12, 12, 'Control gastroenterológico para gastritis', 18),
(13, 13, 'Revisión nefrológica para insuficiencia renal', 20),
(14, 14, 'Tratamiento dermatológico para dermatitis', 11),
(15, 15, 'Consulta hematológica para anemia', 16),
(16, 1, 'Control de diabetes tipo 2', 12),
(17, 2, 'Revisión de hipertensión', 15),
(18, 3, 'Tratamiento de asma', 17),
(19, 4, 'Control de eczema', 13),
(20, 5, 'Tratamiento de artritis', 19),
(21, 6, 'Evaluación cardíaca', 14),
(22, 7, 'Tratamiento de epilepsia', 16),
(23, 8, 'Revisión de síndrome de Down', 20),
(24, 9, 'Control de hipotiroidismo', 12),
(25, 10, 'Tratamiento de insuficiencia renal', 18),
(26, 11, 'Revisión de niveles de glucosa', 15),
(27, 12, 'Evaluación de síntomas neurológicos', 13),
(28, 13, 'Examen pediátrico completo', 20),
(29, 14, 'Control ginecológico anual', 14),
(30, 15, 'Tratamiento para eczema severo', 17),
(31, 1, 'Control oftalmológico', 19),
(32, 2, 'Terapia psicológica para ansiedad', 11),
(33, 3, 'Tratamiento para lesión ortopédica', 15),
(34, 4, 'Revisión endocrinológica', 18),
(35, 5, 'Consulta de seguimiento oncológico', 20),
(36, 6, 'Revisión y seguimiento de enfermedades renales', 16),
(37, 7, 'Consulta de salud mental y ajuste de tratamiento', 13),
(38, 8, 'Tratamiento para lesiones ortopédicas', 20),
(39, 9, 'Chequeo de problemas respiratorios y tratamiento', 12),
(40, 10, 'Evaluación oncológica y tratamiento', 17);
